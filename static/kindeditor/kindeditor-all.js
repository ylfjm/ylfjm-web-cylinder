...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.keplaceholder = K('<div class="ke-placeholder" style="width: 100%; color: rgb(136, 136, 136); padding: 8px; background: none; position: absolute; z-index: 10; top: 0px; border: 0px; overflow: auto; resize: none; pointer-events: none; white-space: pre-wrap; font-size: 13px; display: block; line-height: 18px;">可以在编辑器直接粘贴图片。</div>');
		...
		self.div.append(self.keplaceholder);
		// self.div.append('<div class="ke-placeholder" style="width: 100%; color: rgb(136, 136, 136); padding: 8px; background: none; position: absolute; z-index: 10; top: 0px; border: 0px; overflow: auto; resize: none; pointer-events: none; white-space: pre-wrap; font-size: 13px; display: block; line-height: 18px;">可以在编辑器直接粘贴图片。</div>');
            ...
            function doPasteImg() {
                ...
                if (window.clipboardData) {//ie
                    ...
                    if (e.event.clipboardData.items)//chrome
                        console.log(444)
                        console.log(e.event.clipboardData.items)
